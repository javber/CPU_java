...
public class CmdLineParser {
    ...
    public enum ModeOptionEnum {
    	BATCH, INTERACTIVE, WINDOW, DEBUG
    }
    ...
    public static class IllegalOptionValueException extends OptionException {
		...
		public IllegalOptionValueException( Option opt, String value ) {
			super("Modo incorrecto (parametro -" + opt.shortForm + "|--" + opt.longForm() + ")");
            this.option = opt;
        }
		public IllegalOptionValueException(Option opt) {
			super("Missing argument for option: " + opt.shortForm);
			this.option = opt;
		}
    ...
    public static abstract class Option {
        ...
        /**
         *  An option that expects a ModeOptionEnum value
         */
        public static class ModeOption extends Option{
        	...
        	protected Object parseValue(String arg, Locale locale) throws IllegalOptionValueException{
        		for(ModeOptionEnum mode : ModeOptionEnum.values()){
        			if(mode.toString().toUpperCase().equals(arg.toUpperCase()))
        				return mode;
        		}
        		throw new IllegalOptionValueException(this, arg);
        	}
    ...
    public final Object getOptionValue( Option o, Object def ) {
        Vector<Object> v = (Vector<Object>)values.get(o.longForm());
                ...
                if ( opt.wantsValue() ) {
                    if ( valueArg == null ) {
                        ...
                        if ( position < argv.length ) {
                        	// Para que detecte un argumento con valor que tiene otro argumento seguido
                        	if (argv[position].startsWith("-"))
                        		throw new IllegalOptionValueException(opt);
